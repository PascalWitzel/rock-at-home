...
window.onload = function () {
    document.getElementById('bottonAct1').addEventListener("click", act_eins)
    document.getElementById('bottonAct2').addEventListener("click", act_zwei)
    document.getElementById('bottonAct3').addEventListener("click", act_drei)
...
function act_eins() {
    document.getElementById('bottonAct1').style.color = 'chocolate';
    document.getElementById('bottonAct2').style.color = 'white';
    document.getElementById('bottonAct3').style.color = 'white';
    document.getElementById('carouselExampleIndicators1').style.visibility = 'visible';
    document.getElementById('carouselExampleIndicators2').style.visibility = 'hidden';
    document.getElementById('carouselExampleIndicators3').style.visibility = 'hidden';
}
function act_zwei() {
    document.getElementById('bottonAct1').style.color = 'white';
    document.getElementById('bottonAct2').style.color = 'chocolate';
    document.getElementById('bottonAct3').style.color = 'white';
    document.getElementById('carouselExampleIndicators1').style.visibility = 'hidden';
    document.getElementById('carouselExampleIndicators2').style.visibility = 'visible';
    document.getElementById('carouselExampleIndicators3').style.visibility = 'hidden';
}
function act_drei() {
    document.getElementById('bottonAct1').style.color = 'white';
    document.getElementById('bottonAct2').style.color = 'white';
    document.getElementById('bottonAct3').style.color = 'chocolate';
    document.getElementById('carouselExampleIndicators1').style.visibility = 'hidden';
    document.getElementById('carouselExampleIndicators2').style.visibility = 'hidden';
    document.getElementById('carouselExampleIndicators3').style.visibility = 'visible';
}
function down() {
    document.getElementById('centeredMorning').style.visibility = 'hidden';
    document.getElementById('centeredNight').style.visibility = 'visible';
    document.getElementById('bottonInterviewDown').style.visibility = 'hidden';
    document.getElementById('bottonInterviewUp').style.visibility = 'visible';
}
function up() {
    document.getElementById('centeredMorning').style.visibility = 'visible';
    document.getElementById('centeredNight').style.visibility = 'hidden';
    document.getElementById('bottonInterviewDown').style.visibility = 'visible';
    document.getElementById('bottonInterviewUp').style.visibility = 'hidden';
}
